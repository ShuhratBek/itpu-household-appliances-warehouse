...
public class BlenderDAO extends AbstractDao<Blender> {
    public BlenderDAO() {
        super("blenders.csv", new CsvLineParser<>(Blender::new, List.of(
                ...
                forInt(Blender::setPowerConsumption),
                forInt(Blender::setSpeedSettings),
                forDouble(Blender::setCapacity),
